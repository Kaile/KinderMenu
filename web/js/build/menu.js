...
var Consist, ConsistList, Dish, DishAdd, DishAddList, DishConsist, DishCreate, DishLight, DishesLight, FinalConsist, Ingridient, IngridientInput, InputChangeMixin, Menu, MenuDishList, MenuItem, MenuList, MenuOrder, Portion, Saver, checker, client, debugMode, dumper;
...
Menu = React.createClass({
  ...
  render: function() {
    ...
    }, "\u0418\u0442\u043e\u0433\u043e\u0432\u044b\u0439 \u0441\u043e\u0441\u0442\u0430\u0432:", React.createElement(FinalConsist, {
      "menuId": this.props.menu.id
    })));
  }
});
      ...
      return function(data) {
        ...
        if (data.length) {
          return client['menu-consists'].destroy(data[0].id).done(function(data) {
            ...
            return $('#menu').trigger('dish-update');
          });
        }
      };
    })(this));
...
FinalConsist = React.createClass({
  ...
  componentDidMount: function() {
    this.updateState();
    return $('#menu').on('dish-update', (function(_this) {
      return function() {
        return _this.updateState();
      };
    })(this));
  ...
  updateState: function() {
    return client.consists.read({
      ...
      return function(data) {
        var consistList, item, _i, _len;
        consistList = [];
        for (_i = 0, _len = data.length; _i < _len; _i++) {
          item = data[_i];
          consistList.push(React.createElement(Consist, {
            "consist": item
          }));
        }
        return _this.setState({
  ...
  render: function() {
    return React.createElement("span", null, this.state.consist);
  }
});
