...
var Consist, ConsistList, Dish, DishAdd, DishAddList, DishConsist, DishCreate, DishLight, DishesLight, FinalConsist, Ingridient, IngridientInput, InputChangeMixin, Menu, MenuDishList, MenuItem, MenuList, MenuOrder, Portion, Saver, checker, client, debugMode, dumper, showFailMessage;
  ...
  componentDidMount: function() {
    return client['menu-dishes'].read({
      ...
      return function(existingDishes) {
        ...
        }).fail(function(data) {}, showFailMessage(data));
      };
    })(this)).fail(function(data) {
      return showFailMessage(data);
    });
      ...
      return function(data) {
        if (data.length) {
          return client['menu-consists'].destroy(data[0].id).done(function(data) {
            ...
            return $('#menu').trigger('dishlist:update');
          }).fail(function(data) {
            return showFailMessage(data);
          });
        }
...
FinalConsist = React.createClass({
  ...
  componentDidMount: function() {
    this.updateState();
    return $('#menu').on('dishlist:update', (function(_this) {
      return function() {
        return _this.updateState();
      };
    })(this));
